...
const launchSteps = [
  ...
  'La senere iterasjoner fylle pa med landdata, sammenligning og forslag.',
]
      ...
      <div className="page-grid page-grid-two">
        <article className="card card-feature">
          <div className="card-header">
            ...
            <span className="metric-chip">Browser only</span>
          </div>

          <p className="section-copy">
            Forsiden etablerer plass til hurtigvalg, aktive profiler og tydelige neste steg. Denne
            iterasjonen fokuserer pa struktur, ikke ferdig funksjonalitet.
          </p>

          <ol className="step-list">
            {launchSteps.map((step) => (
              <li key={step} className="list-row">
        ...
        <article className="card">
          <div className="card-header">
            <div>
              ...
              <h2>Eksempel pa reisende som senere kan lagres lokalt</h2>
            </div>
